...
#
# Once that is working, create another dictionary that contains vocabulary that
# players may use. These vocabulary will be the keys, and their values will be
...
# A BETTER WHY TO WRITE ABOVE
    ...
    print()
    #PARSE THE USER INPUT, USING OUR WORD DICTIONARY IF NECESSARY
    if len(direction) > 1: #more than one letter
        for word in vocabulary: #dose the word exsis't in vocabulary
